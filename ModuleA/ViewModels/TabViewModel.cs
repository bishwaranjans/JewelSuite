...
namespace ModuleA.ViewModels
{
    public class TabViewModel : BindableBase
    {
        ...
        {
            get { return _canUpdate && TopHorizon != null && TopHorizon.Length != 0; }
        ...
        public TabViewModel(IApplicationCommands applicationCommands, IVolumeCalculationService volumeCalculationService)
        {
        ...
        private void Update()
        {
            ...
            switch (volumeUnit)
            {
                ...
                case Constants.VolumeUnit.CubicFeet:
                    {
                        VolumeOfOilAndGasInCubicFeet = _volumeCalculationService.CalculateOilAndGasVolumeFromTopHorizon(TopHorizon).ToCubicFeet();
                ...
                case Constants.VolumeUnit.Barrels:
                    {
                        VolumeOfOilAndGasInBarrels = _volumeCalculationService.CalculateOilAndGasVolumeFromTopHorizon(TopHorizon).ToBarrels();
